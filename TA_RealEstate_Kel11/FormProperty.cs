    ...
    public partial class FormProperty : Form
    {
        ...
        { 
            try
            {
                ...
                string kode = null;
                myConnection.Open();
                string sqlQuery = "SELECT TOP (1) MAX(RIGHT (idProperty,2))+1 AS id FROM property";
                ...
                while (dr.Read())
                {
                    ...
                    {
                        autoid = Int32.Parse(dr["id"].ToString());
                    }
                }
        ...
        private void FormProperty_Load_1(object sender, EventArgs e)
        {
        ...
        void LoadData()
        {
            var st = from tb in dc.properties select tb;
